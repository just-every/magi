...
import { ModelProvider, ResponseInput, StreamingEvent, ToolCall, ResponseInputItem } from '../types.js';
...
export class TestProvider implements ModelProvider {
  ...
  async* createResponseStream(
    ...
    costTracker.addUsage({
      ...
      output_tokens: this.config.tokenUsage?.outputTokens || Math.ceil(response.length / 4),
    });
  }
