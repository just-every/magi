        ...
        const tool: ToolFunction = {
            ...
            definition: {
                ...
                function: {
                    ...
                    description:
                        'Generates a Markdown file outlining the project structure',
                    parameters: {
                        type: 'object',
                        required: [
                            'defaults',
                        ...
                        properties: {
                            ...
                            defaults: {
                                type: 'object',
                                description:
                                    'An object containing default configurations',
                            },
                            output_path: {
                                type: 'string',
                                description:
                                    'The file path where the generated Markdown file should be saved',
                            },
                            task_description: {
                                type: 'string',
                                description:
