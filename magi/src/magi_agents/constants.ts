...
export const AGENT_DESCRIPTIONS: Record<string, string> = {
  "ManagerAgent": "Versatile problem solver - handles research, coding, planning, and coordination",
  "ReasoningAgent": "Expert at complex reasoning and multi-step problem-solving",
  "CodeAgent": "Specialized in writing, explaining, and modifying code in any language",
  ...
  "BrowserVisionAgent": "Analyzes images and visual content from websites"
};
