...
export const validThoughtDelays: string[] = ['0', '2', '4', '8', '16', '32', '64', '128'];
...
export function getThoughtTools(): ToolFunction[] {
	return [
		createToolFunction(
			...
			{
				'delay': {
					description: 'The new Thought Delay. Will set to the number of seconds between your thoughts. New messages and system events will interrupt your thought delay to ensure you can respond to them.',
