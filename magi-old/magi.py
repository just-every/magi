...
# Configure logging to show full stack traces for all errors
logging.basicConfig(
    level=logging.INFO,
    ...
    async for event in stream.stream_events():
        ...
        # Process message outputs
            ...
            try:
                ...
                print(f"Error processing RunItemStreamEvent: {str(e)}", file=sys.stderr)
                traceback.print_exc()
            continue
    ...
    async for event in stream.stream_events():
        ...
        # Process message outputs
            ...
            try:
                ...
                print(f"Error processing RunItemStreamEvent during run_magi_command: {str(e)}", file=sys.stderr)
                traceback.print_exc()
            continue
