...
import { connectNativeHost, checkAndReconnectNativeHost } from './communication/messaging';
...
chrome.runtime.onStartup.addListener(() => {
  console.log('[background] Chrome browser started, initializing extension...');
  connectNativeHost(); // Uncommented
});
...
console.log('[background] MAGI Browser Extension Service Worker initialized and running.');
