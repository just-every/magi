...
export const DOM_CONFIG = {
  ...
  // Landmark regions
  LANDMARK_TAGS: [
    'HEADER', 'FOOTER', 'NAV', 'MAIN', 'ASIDE', 'FORM', 'SECTION', 'ARTICLE'
  ],
  LANDMARK_ROLES: [
    'banner', 'contentinfo', 'navigation', 'main', 'complementary', 'form', 'region', 'search'
  ],
  
  // Elements to ignore
  IGNORE_TAGS: [
    'SCRIPT', 'STYLE', 'HEAD', 'META', 'LINK', 'NOSCRIPT', 'TEMPLATE', 'OBJECT', 
    'EMBED', 'PATH', 'LINE', 'POLYLINE', 'RECT', 'CIRCLE', 'ELLIPSE', 'SVG'
  ],
  
  // Potentially interesting content elements
  POTENTIALLY_INTERESTING_TAGS: [
    'P', 'LI', 'TD', 'TH', 'DT', 'DD', 'CODE', 'PRE', 'BLOCKQUOTE', 
