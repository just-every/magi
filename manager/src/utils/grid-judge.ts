 ...
 * for both manager search and image generation workflows.
 */
...
import { MANAGER_ASSET_TYPES } from '../constants.js';
...
export interface JudgeOptions<T> {
    ...
    /** Whether this is for manager search (true) or image generation (false) */
 ...
 *
 * This is a shared implementation used by both the manager search and
