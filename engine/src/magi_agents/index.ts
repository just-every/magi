...
export async function createAgent(
    ...
    // Note: Event handling is now done via the global event handler set in magi.ts
    // No need to set onEvent on individual agents anymore
