...
• **Projects** - Use \`create_project({project_id})\`; agents work in \`task/{taskId}\` git branches.
...
`;
    ...
    // MechContext is no longer needed as getThoughtTools doesn't take parameters
