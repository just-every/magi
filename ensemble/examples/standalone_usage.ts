...
// ================================================================
// Standalone Usage Example - Demonstrates the new ensemble API without loading legacy providers
// ================================================================

import { Conversation } from '../core/conversation.js';
import { createUserMessage } from '../core/message_factory.js';
...
import { registerProvider, clearProviders } from '../provider/base_provider.js';
...
async function main() {
    console.log('=== Ensemble Standalone Usage Example ===\n');
    ...
    const toolRegistry = createToolRegistry([weatherTool]);
