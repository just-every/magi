...
test.describe('Sequential Runner', () => {
    test('should run a sequence of agents', async ({
        ...
        const runnerConfig: RunnerConfig = {
            'first-step': {
                agent: () => {
                    ...
                    testProviderConfig.fixedResponse =
                        'First step completed successfully. Proceed to second step.';
            ...
            'second-step': {
                agent: () => {
                    ...
                    // Configure provider for this step
                    testProviderConfig.fixedResponse =
                        'Second step completed successfully. Proceed to final step.';
                ...
                input: (history: ResponseInput) => {
                    ...
                    const firstStepOutput = history.find(
                        msg =>
                            ...
                            msg.content.includes('First step')
                    );
            ...
            'third-step': {
                agent: () => {
                    ...
                    // Configure provider for this step
                    testProviderConfig.fixedResponse =
                        'Final step completed. All steps executed successfully.';
        ...
        expect(executionSequence).toEqual([
            'first-step',
            'second-step',
            'third-step',
        ]);
    ...
    test('should handle retries when a step fails', async ({
        configureTestProvider,
    }) => {
            ...
            'first-step': {
                agent: () => {
                    ...
                    return new Agent({
                        ...
                        instructions:
                            'You are an agent that tests the retry mechanism',
                        model: 'test-standard',
                    });
                },
        ...
        setTimeout(() => {
            ...
            testProviderConfig.fixedResponse =
                'Retry succeeded, this attempt was successful.';
        }, 500);
        ...
        // Count retries
        const firstStepCount = executionSequence.filter(
